...
var store = shared.store || (shared.store = new (__webpack_require__(652))());
...
// @@match logic
__webpack_require__(132)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
__webpack_require__(132)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
// @@search logic
__webpack_require__(132)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
var advanceStringIndex = __webpack_require__(195);
var toLength = __webpack_require__(21);
var callRegExpExec = __webpack_require__(138);
var regexpExec = __webpack_require__(208);
var fails = __webpack_require__(8);
var $min = Math.min;
var $push = [].push;
...
// @@split logic
__webpack_require__(132)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
  if (
    'abbc'[$SPLIT](/(b)*/)[1] == 'c' ||
...
var uid = __webpack_require__(92);
var wks = __webpack_require__(11);
var wksExt = __webpack_require__(311);
var wksDefine = __webpack_require__(539);
...
// import 'classlist.js';
//# sourceMappingURL=D:/Work/github-branches/NgHackerNews/src/polyfills.js.map
...
$export($export.S, 'Array', { isArray: __webpack_require__(202) });
...
$export($export.P + $export.F * (__webpack_require__(87) != Object || !__webpack_require__(29)(arrayJoin)), 'Array', {
...
$export($export.P, 'Function', { bind: __webpack_require__(290) });
...
$export($export.S, 'Math', { fround: __webpack_require__(536) });
...
var $export = __webpack_require__(1);
var $parseFloat = __webpack_require__(307);
...
$export($export.S + $export.F * !__webpack_require__(19), 'Object', { defineProperties: __webpack_require__(304) });
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(63), __webpack_require__(664)))
